        ...
        <div className="chat-header-left">
          ...
          <div className="chat-header-avatar-wrap">
            <div
              ...
              style={{
                background: getAvatarColor(recipient.username),
                borderRadius: "50%",
              }}
            >
            ...
            <span
              className={`presence-dot presence-dot-header ${isOnline ? "presence-online" : "presence-offline"}`}
            ></span>
          </div>
          <div className="chat-header-info">
            ...
            <div className="chat-header-meta">
              <span
                className={`chat-header-online-dot ${isOnline ? "" : "chat-header-offline-dot"}`}
              ></span>
